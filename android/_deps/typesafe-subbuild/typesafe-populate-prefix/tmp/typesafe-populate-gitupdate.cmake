...
execute_process(
  COMMAND "/usr/bin/git" --git-dir=.git show-ref "cdf334cd8e5fcb5e21ab470decdfcbd190ef7347"
  WORKING_DIRECTORY "/home/runner/work/client/client/build-android/_deps/typesafe-src"
...
if(show_ref_output MATCHES "^[a-z0-9]+[ \\t]+refs/remotes/")
  ...
  set(checkout_name "cdf334cd8e5fcb5e21ab470decdfcbd190ef7347")
...
elseif(show_ref_output MATCHES "^[a-z0-9]+[ \\t]+refs/tags/")
  ...
  get_hash_for_ref("cdf334cd8e5fcb5e21ab470decdfcbd190ef7347" tag_sha error_msg)
  if(tag_sha STREQUAL head_sha)
    message(VERBOSE "Already at requested tag: cdf334cd8e5fcb5e21ab470decdfcbd190ef7347")
    return()
  endif()
...
elseif(show_ref_output MATCHES "^[a-z0-9]+[ \\t]+refs/heads/")
  ...
  set(checkout_name "origin/cdf334cd8e5fcb5e21ab470decdfcbd190ef7347")
  ...
  elseif(tag_sha STREQUAL "")
    ...
    if(NOT can_fetch)
      message(FATAL_ERROR
        "Requested git ref \"cdf334cd8e5fcb5e21ab470decdfcbd190ef7347\" is not present locally, and not "
...
if(git_update_strategy STREQUAL "CHECKOUT")
  ...
  if(error_code)
    ...
    if(NOT git_update_strategy STREQUAL "REBASE_CHECKOUT")
      ...
      message(FATAL_ERROR "\nFailed to rebase in: '/home/runner/work/client/client/build-android/_deps/typesafe-src'."
...
if(need_stash)
  ...
  if(error_code)
    ...
    if(error_code)
      ...
      message(FATAL_ERROR "\nFailed to unstash changes in: '/home/runner/work/client/client/build-android/_deps/typesafe-src'."
                          "\nYou will have to resolve the conflicts manually")
    endif()
  endif()
endif()
