...
execute_process(
  COMMAND "/usr/bin/git" --git-dir=.git show-ref "d4014c74dc3793aba95ae354d6e23a026c2796db"
  WORKING_DIRECTORY "/home/runner/work/client/client/build-android/_deps/entt-src"
...
if(show_ref_output MATCHES "^[a-z0-9]+[ \\t]+refs/remotes/")
  ...
  set(checkout_name "d4014c74dc3793aba95ae354d6e23a026c2796db")
...
elseif(show_ref_output MATCHES "^[a-z0-9]+[ \\t]+refs/tags/")
  ...
  get_hash_for_ref("d4014c74dc3793aba95ae354d6e23a026c2796db" tag_sha error_msg)
  if(tag_sha STREQUAL head_sha)
    message(VERBOSE "Already at requested tag: d4014c74dc3793aba95ae354d6e23a026c2796db")
    return()
  endif()
...
elseif(show_ref_output MATCHES "^[a-z0-9]+[ \\t]+refs/heads/")
  ...
  set(checkout_name "origin/d4014c74dc3793aba95ae354d6e23a026c2796db")
  ...
  elseif(tag_sha STREQUAL "")
    ...
    if(NOT can_fetch)
      message(FATAL_ERROR
        "Requested git ref \"d4014c74dc3793aba95ae354d6e23a026c2796db\" is not present locally, and not "
...
if(git_update_strategy STREQUAL "CHECKOUT")
  ...
  if(error_code)
    ...
    if(NOT git_update_strategy STREQUAL "REBASE_CHECKOUT")
      ...
      message(FATAL_ERROR "\nFailed to rebase in: '/home/runner/work/client/client/build-android/_deps/entt-src'."
...
if(need_stash)
  ...
  if(error_code)
    ...
    if(error_code)
      ...
      message(FATAL_ERROR "\nFailed to unstash changes in: '/home/runner/work/client/client/build-android/_deps/entt-src'."
                          "\nYou will have to resolve the conflicts manually")
    endif()
  endif()
endif()
